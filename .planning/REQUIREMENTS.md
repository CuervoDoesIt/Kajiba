...
- [x] **PRIV-03**: GLiNER tested against code content fixtures to calibrate false positive rates on programming identifiers (calibration test + fixture shipped 07-04; LANE-B gated — completes when `[llm-scrub]` runs)
